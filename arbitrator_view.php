...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $queryx = "SELECT * FROM arbitrator WHERE id = '$id'";
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Arbitrator Profile</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Arbitrator Profile</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="mediator-profile-card">
                        ...
                        <div class="mediator-image">
                            <?php
                            if (!empty($datax['pic'])) {
                                echo "<img src='arbpic/" . $datax['pic'] . "' alt='Mediator Image'>";
                            } else {
                                echo "<img src='arbpic/default.png' alt='Default Image'>";
                            }
                            ?>
                        </div>
                        ...
                        <div class="mediator-info">
                            ...
                            <p><strong>Note:</strong> One of the best Arbitrator you can trust easily.</p>
                        </div>
                    </div>
                </div>
            </div>
