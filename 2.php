        ...
        <div class="container blog-container">
            <article class="blog-post">
                <div class="blog-post-content">
                    <img src="img2/2a.png" alt="Blog Image">
                    <div class="blog-post-title">
                        <h2 style="color: orange;">Land Acqusition</h2>
                    </div>
                </div>
                <p>
                Land acquisition, a process by which the government acquires private land for public purposes, plays a pivotal role in the economic development of Bangladesh, a nation grappling with a burgeoning population and swift urbanization.
                </p>
                <p>   This article meticulously examines the complexities of land acquisition legislation in Bangladesh, scrutinizing its historical backdrop, essential components, challenges, and the intricate equilibrium between advancing development and upholding individual rights.
                </p>
                <p>
                Land must serve a “public purpose,” encompassing infrastructure development,
                 urban planning, or public amenities. The definition of public purpose has evolved over time to adapt to the changing needs of society.
                </p>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>alliace@email.com</p>
