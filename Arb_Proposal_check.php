...
<head>
    ...
    <title>Arbitration Verification</title>
        ...
        <table border="1">
            ...
            if (isset($_POST['accept'])) {
                if (!empty($_POST['arbitrator_id']) && !empty($_POST['link'])) {
                    ...
                    $mail->isHTML(true);
                    $mail->Subject = 'Arbitration Consultancy Link';
                    $mail->Body = 'Your Mediation Consultancy Link is given below:<br>' . $link;
            ...
            $sql = "SELECT ac.casenumber, ap.email1, ap.email2
