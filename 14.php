        ...
        <div class="container blog-container">
            <article class="blog-post">
                <div class="blog-post-content">
                    <img src="img2/14a.png" alt="Blog Image">
                    <div class="blog-post-title">
                        <h2 style="color: orange;">Advisory, Due Diligence & Title Investigation</h2>
                    </div>
                </div>
                <p>
                 In general terms, due diligence refers to the process of investigating and verifying information regarding a property by
                 vetting potential issues or risks that may affect the purposes of the investment later in time.
                 Due diligence is perhaps the best decision that an investor and/or expat can make when deciding to purchase a property.
                </p>
                <p>
                With the legal due diligence, the buyer can ensure the legal status of the property, the title's transferability,
                 and the non-existence of legal contingencies that may affect ownership, possession, and enjoyment.
                </p>
                <p>
                Real Estate Due Diligence is the process of investigating a property's legal, financial, and physical aspects before a transaction to minimize risks.
                Our lawyer can assist with contract reviews, due diligence investigations, title searches, negotiating terms, and ensuring legal compliance throughout the transaction.
                </p>
                <p>
                The cost of hiring a lawyer for Real Estate Due Diligence can vary based on the complexity of the transaction, the lawyer's experience, and the services required.
                </p>
