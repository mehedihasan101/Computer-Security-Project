...
<?php
    ...
    include("middleware.php");
     // Allow all roles
     enforce_access(['user','lawyer','admin']);
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        <a href="Homepage.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h1 class="m-0 text-primary"><i class="far fa-hospital me-3"></i>Quick Solution</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="querry.php" class="nav-item nav-link">Querry</a>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        ...
                        <a href="lawyer.php" class="dropdown-item">Lawyers</a>
                    </div>
                </div>
                <a href="profile.php" class="nav-item nav-link">Profile</a>
            </div>
            <a href="lawyer_registration.php" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">Registes<i class="fa fa-arrow-right ms-3"></i><br>as lawyer</a>
        </div>
    </nav>
-->
