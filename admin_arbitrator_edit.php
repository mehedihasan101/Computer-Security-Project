...
$sql = "SELECT * FROM arbitrator WHERE id = '$id' LIMIT 1";
...
if (isset($_POST["submit"])) {
    ...
    // Update the database
    $sql = "UPDATE arbitrator SET name='$name', email='$email', phone='$phone', experience='$experience', qualification='$qualification', profession='$profession', status='$status', pic='$pic' WHERE id='$id'";
    $result = mysqli_query($conn, $sql);
...
<head>
  ...
  <title>Edit Arbitrator Profile</title>
...
<body>
  ...
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5">
    Admin Arbitrator Edit Profile
  </nav>

  <div class="container">
    <div class="text-center mb-4">
      <h3>Edit Arbitrator Information</h3>
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" enctype="multipart/form-data" style="width:50vw; min-width:300px;">
        ...
        <div class="mb-3">
          ...
          <img id="preview" class="preview-img" src="arbpic/<?php echo $row['pic']; ?>" alt="Current Image">
        </div>
