        ...
        <div class="container blog-container">
            <article class="blog-post">
                <div class="blog-post-content">
                    <img src="img2/1a.png" alt="Blog Image">
                    <div class="blog-post-title">
                        <h2 style="color: orange;">Alternative Dispute Resolution</h2>
                    </div>
                </div>
                <h3 style="margin-top:15px;">Arbitration & Mediation</h3>
                <p>Parties may choose Mediation/Arbitration when there is a possibility of resolving the conflict in mediation,
                     but they want certainty that a result will be forthcoming even if mediation fails.
                     The process would start as an ordinary mediation with the exception that parties contract with the mediator/arbitrator to ensure that if mediation fails,
                      the process will move into an arbitration
                </p>
