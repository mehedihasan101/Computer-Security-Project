        ...
        <div class="container blog-container">
            <article class="blog-post">
                <div class="blog-post-content">
                    <img src="img2/6a.png" alt="Blog Image">
                    <div class="blog-post-title">
                        <h2 style="color: orange;">Devorce / Separation</h2>
                    </div>
                </div>
                <p>
                Navigate divorce seamlessly with Alliance. There are two kinds of divorce: contested and uncontested.
                In a contested divorce, the parties are unable to agree on the terms of the divorce, such as guardianship (formerly
                known as custody and access), parenting orders, child support, spousal support and property division. A contested divorce 
                may be costly as parties often have to make multiple Court applications and sometimes end up going to trial.
                </p>

                <p>
                At Alliance, we will support you in determine whether the Court system or an alternative dispute resolution is best for you.
                In a contested divorce, we work closely with you to understand the nature of the disputes and what your expectations are with
                respect to the outcomes. Our team of family lawyers offer several approaches to resolving your disputes, including mediation and litigation.
                </p>

                <p>
                In an uncontested divorce, the parties have reached an agreement on all issues and do not require the Court to make any decisions about the terms
                of the divorce; the only remaining matter is to draft the agreement and file the divorce with the Courts. The uncontested divorce process moves much
                faster through the system and creates less of a financial burden on both parties.
                </p>
