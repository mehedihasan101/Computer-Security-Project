        ...
        <div class="container blog-container">
            <article class="blog-post">
                <div class="blog-post-content">
                    <img src="img2/10a.png" alt="Blog Image">
                    <div class="blog-post-title">
                        <h2 style="color: orange;">Legal Opinion & Litigation</h2>
                    </div>
                </div>
                <p>
                    The litigation process begins when a certain dispute ends up in court and due to its complexity and length it cannot be solved
                    successfully without legal representation. A litigator will come not only with the necessary knowledge of law, but he will also
                    have the ability to represent you in front of the court and/or in negotiations and ensures the compliance of all the required paperwork.
                </p>
                <p>
                    Our team of lawyers can provide full litigation support and services that occur in areas such as: real estate, labour law, commercial law
                    or other complex business-related disputes.
                </p>
                <p>
                    We will offer full administrative legal support, legal advisory and representation of the parties in front of the Administrative Court, Civil
                    Court or financial authorities. Moreover, we can also assist you in any out of court negotiations.
                </p>
